...
$langs->loadLangs(array('companies', 'admin', 'products', "fichemag@fichemag"));
...
print dol_get_fiche_head($head, 'fichemag_extrafields', $langs->trans($title), -1, "fichemag@fichemag");
