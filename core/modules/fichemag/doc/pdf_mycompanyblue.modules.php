...
/**
 *	\file       htdocs/custom/fichemag/core/modules/fichemag/doc/pdf_mycompanyblue.modules.php
 *	\ingroup    fichemag
 *	\brief      File of Class to generate PDF proposal with Cyan template
 */
require_once DOL_DOCUMENT_ROOT.'/custom/fichemag/core/modules/fichemag/modules_fichemag.php';
 ...
 */
class pdf_mycompanyblue extends ModelePDFFichemags
{
	/**
	...
	protected function drawSignatureArea(&$pdf, $object, $posy, $outputlangs)
	{
		...
		$pdf->SetFont('', '', $default_font_size - 2);
		$pdf->MultiCell($largcol, $tab_hl, $outputlangs->transnoentities("ProposalCustomerSignature"), 0, 'L', true);
